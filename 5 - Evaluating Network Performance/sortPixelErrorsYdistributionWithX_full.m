            ...
            for z = 1:size(pixPairTable{x,y}{1}{1},1)
                if pixPairTable{x,y}{1}{2}(z,1)<range1
                    if pixPairTable{x,y}{1}{2}(z,2)<range1Y
                        range1pixErrX1 = [range1pixErrX1; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];  
                    elseif pixPairTable{x,y}{1}{2}(z,2)>=range1Y && pixPairTable{x,y}{1}{2}(z,2)<=range2Y
                        range1pixErrX2 = [range1pixErrX2; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
...
%                         range1pixErrX4 = [range1pixErrX4; (pixPairTable{x,y}{1}{2}(z,1)-pixPairTable{x,y}{1}{1}(z,1))];   
                ...
                elseif pixPairTable{x,y}{1}{2}(z,1)>=range1 && pixPairTable{x,y}{1}{2}(z,1)<range2
                    if pixPairTable{x,y}{1}{2}(z,2)<range1Y
                        range2pixErrX1 = [range2pixErrX1; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];  
                    elseif pixPairTable{x,y}{1}{2}(z,2)>=range1Y && pixPairTable{x,y}{1}{2}(z,2)<=range2Y
                        range2pixErrX2 = [range2pixErrX2; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                     elseif pixPairTable{x,y}{1}{2}(z,2)>=range2Y && pixPairTable{x,y}{1}{2}(z,2)<=range3Y
%                         range1pixErrX3 = [range1pixErrX3; (pixPairTable{x,y}{1}{2}(z,1)-pixPairTable{x,y}{1}{1}(z,1))];
%                     elseif pixPairTable{x,y}{1}{2}(z,2)>=range3Y && pixPairTable{x,y}{1}{2}(z,2)<=range4Y
%                         range1pixErrX4 = [range1pixErrX4; (pixPairTable{x,y}{1}{2}(z,1)-pixPairTable{x,y}{1}{1}(z,1))];   
                ...
                elseif pixPairTable{x,y}{1}{2}(z,1)>=range2 && pixPairTable{x,y}{1}{2}(z,1)<=range3
                    if pixPairTable{x,y}{1}{2}(z,2)<range1Y
                        range3pixErrX1 = [range3pixErrX1; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];  
                    elseif pixPairTable{x,y}{1}{2}(z,2)>=range1Y && pixPairTable{x,y}{1}{2}(z,2)<=range2Y
                        range3pixErrX2 = [range3pixErrX2; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                     elseif pixPairTable{x,y}{1}{2}(z,2)>=range2Y && pixPairTable{x,y}{1}{2}(z,2)<=range3Y
%                         range1pixErrX3 = [range1pixErrX3; (pixPairTable{x,y}{1}{2}(z,1)-pixPairTable{x,y}{1}{1}(z,1))];
%                     elseif pixPairTable{x,y}{1}{2}(z,2)>=range3Y && pixPairTable{x,y}{1}{2}(z,2)<=range4Y
%                         range1pixErrX4 = [range1pixErrX4; (pixPairTable{x,y}{1}{2}(z,1)-pixPairTable{x,y}{1}{1}(z,1))];   
...
title('Distribution for Y Error Ranges w.r.t X and Y pixel values')
hold on
...
zbottomComp12 = (pd4.mu-pd6.mu)/sqrt(pd4.sigma^2/length(range2pixErrX2)+pd6.sigma^2/length(range3pixErrX2))
