...
% combine range 1 and 2 and range 12 and 13
range1 = 161;
% range2 = 165;
% range3 = 168;
% range3 = 172;
        ...
        if size(pixPairTable{x,y}{1}{1},1)>0
            for z = 1:size(pixPairTable{x,y}{1}{1},1)
                if pixPairTable{x,y}{1}{2}(z,2)<range1
                    range1pixErrY = [range1pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];                
                elseif pixPairTable{x,y}{1}{2}(z,2)>=range1 && pixPairTable{x,y}{1}{2}(z,2)<range2
                    range2pixErrY = [range2pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
                elseif pixPairTable{x,y}{1}{2}(z,2)>=range2 && pixPairTable{x,y}{1}{2}(z,2)<range3
                    range3pixErrY = [range3pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
                elseif pixPairTable{x,y}{1}{2}(z,2)>=range3 && pixPairTable{x,y}{1}{2}(z,2)<range4
                    range4pixErrY = [range4pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range4 && pixPairTable{x,y}{1}{2}(z,2)<range5
%                     range5pixErrY = [range5pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range5 && pixPairTable{x,y}{1}{2}(z,2)<range6
%                     range6pixErrY = [range6pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range6 && pixPairTable{x,y}{1}{2}(z,2)<range7
%                     range7pixErrY = [range7pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];    
...
%                     range9pixErrY = [range9pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range9 && pixPairTable{x,y}{1}{2}(z,2)<=range10
%                     range10pixErrY = [range10pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range10 && pixPairTable{x,y}{1}{2}(z,2)<=range11
%                     range11pixErrY = [range11pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range11 && pixPairTable{x,y}{1}{2}(z,2)<=range12
%                     range12pixErrY = [range12pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range12 && pixPairTable{x,y}{1}{2}(z,2)<=range13
%                     range13pixErrY = [range13pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range13 && pixPairTable{x,y}{1}{2}(z,2)<=range14
%                     range14pixErrY = [range14pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];   
%                 elseif pixPairTable{x,y}{1}{2}(z,2)>=range14 && pixPairTable{x,y}{1}{2}(z,2)<=range15
%                     range15pixErrY = [range15pixErrY; (pixPairTable{x,y}{1}{2}(z,2)-pixPairTable{x,y}{1}{1}(z,2))];    
                end
...
title('Check Distribution for All Error Ranges')
hold on
